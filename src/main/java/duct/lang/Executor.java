...
import duct.lang.value.impl.ReferenceValue;
...
public interface Executor {
	 ...
	 **/
	URL requestJurisdictionURL( String jurisdictionName );
	 ...
	 **/
	default void displayValue( Value val ){
		displayValue( val, "" );
	}
	 ...
	 **/
	void displayValue( Value val, CharSequence label );
	 ...
	 **/
	Operation getOperation( CharSequence identifier );
	 ...
	 **/
	Value getValue( CharSequence identifier );

	default Value getValue( ReferenceValue reference ){
		return this.getValue( reference.getBaseValueAsString() );
	}
	/**
	 ...
	 **/
	void saveElement( CharSequence identifier, Operation operation );
	 ...
	 **/
	void saveElement( CharSequence identifier, Value value );
	 ...
	 **/
	default void saveElement( CharSequence identifier, Element element ){
	 ...
	 **/
	Module loadModule(CharSequence identifier );
	 ...
	 **/
	Script loadScript( CharSequence identifier, CharSequence pkg );
	 ...
	 **/
	Map<String, byte[]> moduleSettings( CharSequence moduleName );
